...
<html lang="en">
    <head>
        ...
        <title>Uniluk_Knowledge_Management</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                        ...
                        <li class="nav-item"><a href="?idd=<?="publierdocuments" ?>" class="nav-link" >Publier_Article</a></li>
      ...
      <div class="container-fluid py-1 px-3">
        ...
        include("documentsAcceuilAcademique.php");
    ?>
       <center>  <h1 class="card-title">Les Informations: </h1> </center>
    <?php
        include("forms/connexion.php");
            $IDFAC=$_SESSION['faculte'];
            $getFac=$connexion->query("SELECT * FROM tdecanat ");
            $dataFac=$getFac->fetch();-
            $idfacu=$dataFac['id_decanat'];

            $getActiviter=$connexion->query("SELECT * FROM tactivite ORDER BY id_activite DESC");
            ...
            while ($dataActiviter=$getActiviter->fetch()) {
                ...
                <div  class="container px-4 px-lg-5 mt-5">
                  ...
                  <?=$dataActiviter['created_at'] ?>                      
                        ...
                        <div class="col-md-12">
                        <a href="traitementFichier.php?idf=<?=$dataActiviter['id_activite'];?>" class="btn btn-outline-dark stretched-link">Ouvrir le fichier</a>
                        </div>
                        </center>
