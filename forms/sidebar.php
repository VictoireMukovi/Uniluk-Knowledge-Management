...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <hr class="horizontal light mt-0 mb-2">
                       ...
                       <?php 
                        include("connexion.php");
                        $getAllClasseur=$connexion->query("SELECT *FROM tclasseur WHERE id_faculte=$decanat ");
                        ...
                        ?>
                              ...
                              <li class="nav-item">
                                <a class="nav-link text-white active bg-gradient" href="?id=<?=$Infos['id_classeur']; ?>">
                                  ...
                                  <span class="nav-link-text ms-1"><?php echo($Infos['description'])?></span>
                                </a>
                              </li>
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      ...
      <div class="mx-3">
        <a class="btn bg-gradient-primary mt-4 w-100" href="logAoutAction.php" type="button">Déconnexion</a>
      </div>
    </div>
  </aside>
</body>
