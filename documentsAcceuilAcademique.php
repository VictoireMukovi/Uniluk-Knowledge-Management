...
include("forms/connexion.php");
        if($id=="documentsAca"){?>
           ...
           // echo($idfac);
            ...
            $getAllFile=$connexion->query("SELECT * FROM tfichier WHERE id_classeur=$idClsr ");
                ...
                <div class="container px-4 px-lg-5 mt-5">
                  ...
                  <div class="card" style="width: 24rem;height: 17rem;">
                        ...
                        <p class="card-text">
                         ...
                         <form method="GET">
                               <a href="forms/liens.php?idf=<?=$file['id'];?>" class="btn btn-outline-dark stretched-link">Ouvrirnnn le fichier</a>
    ...
    $getAllFileP=$connexion->query("SELECT * FROM tfichier WHERE id_classeur=$idClsrP ");
...
//FinProj Tutore
 ...
 $getAllFilePR=$connexion->query("SELECT * FROM tfichier WHERE id_classeur=$idClsrPR ");
